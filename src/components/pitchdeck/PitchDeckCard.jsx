...
export default function PitchDeckCard({ icon, title, description }) {
    // RENDER LOGIC
    return (
        <div className="bg-transparent border-2 border-[#BFA200] rounded-lg p-6 flex flex-col items-center transition-transform duration-300 hover:scale-105 h-full space-y-2 md:space-y-4">
