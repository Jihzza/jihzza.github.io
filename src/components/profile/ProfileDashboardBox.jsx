...
const ProfileDashboardBox = ({ 
  ...
  const content = (
    <div className={`bg-white/10 backdrop-blur-md rounded-lg p-4 shadow-sm border border-white/20 hover:bg-white/15 hover:shadow-md transition-all duration-200 ${className}`}>
