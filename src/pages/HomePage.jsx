        ...
        <div
            ...
            >
                ...
                <Link
                   ...
                   <Link to="/scheduling" className="px-8 py-3 rounded-md text-lg font-medium bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
                    Book a Call
                   </Link>
        </div>
    );
